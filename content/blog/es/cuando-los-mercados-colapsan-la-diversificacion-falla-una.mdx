...
coverImageAttribution: "*Photo by [Miguel González](https://www.pexels.com/@mikegles) on [Pexels](https://www.pexels.com)*"
---
...
*La ventaja del enfoque estructural es que la exposición no correlacionada ya está colocada cuando comienza una crisis. — Foto de [RDNE Stock project](https://www.pexels.com/@rdne) en [Pexels](https://www.pexels.com)*
...
*El enfoque reactivo gana terreno al evitar el arrastre de activos defensivos permanentes, aunque exige detectar cambios de régimen con velocidad. — Foto de [Dylan Chan](https://www.pexels.com/@dylan-chan-2880813) en [Pexels](https://www.pexels.com)*
...
*El problema oculto es que el riesgo cambia de forma en cada crisis, volviendo obsoletas las correlaciones históricas. — Foto de [Sandisk](https://unsplash.com/@sandisk) en [Unsplash](https://www.unsplash.com)*
