...
coverImageAttribution: "*Foto de [Kindel Media](https://www.pexels.com/@kindelmedia) en [Pexels](https://www.pexels.com)*"
---
...
*El petróleo explica el repunte del IPC, pero la inflación subyacente y la vivienda definen si será persistente. — Foto de [RDNE Stock project](https://www.pexels.com/@rdne) en [Pexels](https://www.pexels.com)*
...
*Un segundo dato inflacionario consecutivo en 3.8% reduce las posibilidades de un recorte de tasas de la Fed en 2026. — Foto de [Jakub Żerdzicki](https://unsplash.com/@jakubzerdzicki) en [Unsplash](https://www.unsplash.com)*
...
*Las categorías de servicios no energéticos que se aceleran simultáneamente desmontan la narrativa del shock petrolero transitorio. — Foto de [Bia Limova](https://www.pexels.com/@bia-limova-1908542654) en [Pexels](https://www.pexels.com)*
