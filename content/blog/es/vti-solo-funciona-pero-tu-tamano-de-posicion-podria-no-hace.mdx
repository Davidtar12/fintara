...
coverImageAttribution: "*Photo by [Shantanu Goyal](https://www.pexels.com/@shantanu09) on [Pexels](https://www.pexels.com)*"
---
...
*La diferencia entre sufrir una caída del 35% o de apenas 17,500 dólares depende de cuánto del patrimonio total esté expuesto a renta variable. — Foto de [Lukas Blazek](https://www.pexels.com/@goumbik) en [Pexels](https://www.pexels.com)*
...
*El lenguaje de tamaño de posición migró desde la selección activa de acciones hacia portafolios pasivos, donde pierde su lógica matemática original. — Foto de [Kampus Production](https://www.pexels.com/@kampus) en [Pexels](https://www.pexels.com)*
...
*La tensión entre preservar una reserva de efectivo para emergencias y el arrastre acumulado que esa liquidez genera en el retorno a largo plazo. — Foto de [Hanna Pad](https://www.pexels.com/@anna-nekrashevich) en [Pexels](https://www.pexels.com)*
