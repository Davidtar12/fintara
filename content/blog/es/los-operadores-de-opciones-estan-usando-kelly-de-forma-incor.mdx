...
coverImageAttribution: "*Foto de [Jakub Zerdzicki](https://www.pexels.com/@jakubzerdzicki) en [Pexels](https://www.pexels.com)*"
---
...
*La fórmula de Kelly permite calcular la fracción del capital que conviene asignar a una sola operación antes de invertir. — Foto de [RDNE Stock project](https://www.pexels.com/@rdne) en [Pexels](https://www.pexels.com)*
...
*Los pagos asimétricos de las opciones exigen adaptar la fórmula de Kelly tradicional a sus estructuras particulares. — Foto de [m.](https://unsplash.com/@m_____me) en [Unsplash](https://www.unsplash.com)*
...
*Aplicar medio o cuarto de Kelly reduce la volatilidad del drawdown sin sacrificar gran parte del crecimiento geométrico a largo plazo. — Foto de [AlphaTradeZone](https://www.pexels.com/@alphatradezone) en [Pexels](https://www.pexels.com)*
