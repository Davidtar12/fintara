...
coverImageAttribution: "*Photo by [Magic Fan](https://unsplash.com/@magicunsplash) on [Unsplash](https://www.unsplash.com)*"
---
...
*Official House and Senate disclosure portals list standardized transaction details for members, though exact share counts and dollar values remain hidden. — Photo by [StockRadars Co.,](https://www.pexels.com/@stockradars-co-1851828201) on [Pexels](https://www.pexels.com)*
...
*Weekly congressional trading totals depend on assumptions about where within each disclosed range the real trade value actually fell. — Photo by [Tima Miroshnichenko](https://www.pexels.com/@tima-miroshnichenko) on [Pexels](https://www.pexels.com)*
