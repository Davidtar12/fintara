...
*Multinational companies mask real dollar returns with constant-currency metrics, hiding how DXY regimes quietly drive portfolio performance gaps. — [Wikipedia contributors](https://en.wikipedia.org/wiki/Meta_Platforms), via [Wikimedia Commons](https://commons.wikimedia.org)*
