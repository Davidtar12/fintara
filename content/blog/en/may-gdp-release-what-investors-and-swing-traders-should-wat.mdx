...
*GDP surprises trigger sector rotation, favoring cyclicals on strong prints and defensives on weak ones. — [The original uploader was Snow storm in Eastern Asia at English Wikipedia.](https://commons.wikimedia.org/wiki/File:PIIGS_Mk_4_map.png), via [Wikimedia Commons](https://commons.wikimedia.org)*
