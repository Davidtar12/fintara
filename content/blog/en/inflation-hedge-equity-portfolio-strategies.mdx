...
*Non-US equities buffer portfolios against country-specific inflation regimes and currency shifts but cannot shield investors from global inflation shocks. — [Wikipedia contributors](https://en.wikipedia.org/wiki/S%26P_Global), via [Wikimedia Commons](https://commons.wikimedia.org)*
